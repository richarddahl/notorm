...
class UserService(UnoEntityService[User]):
    ...
    async def find_by_handle(self, handle: str, tenant_id: Optional[str] = None) -> Result[Optional[User]]:
        """
    ...
    async def find_superusers(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error finding superusers: {str(e)}"))
    ...
    async def add_to_group(self, user_id: str, group_id: str) -> Result[User]:
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error adding user to group: {str(e)}"))
    ...
    async def add_role(self, user_id: str, role_id: str) -> Result[User]:
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error adding role to user: {str(e)}"))
    ...
    async def check_permission(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error checking permission: {str(e)}"))
...
class RoleService(UnoEntityService[Role]):
    ...
    async def find_by_responsibility(
        ...
        try:
            repository = cast(RoleRepository, self.repository)
            results = await repository.find_by_responsibility(responsibility_id, limit, offset)
            return Success(results)
        except Exception as e:
    ...
    async def get_with_relationships(self, id: str) -> Result[Role]:
        ...
        try:
            ...
            if self.permission_service:
                permission_repo = cast(PermissionRepository, self.permission_service.repository)
            ...
            if self.responsibility_service:
                responsibility_repo = cast(ResponsibilityRoleRepository, self.responsibility_service.repository)
    ...
    async def add_permission(self, role_id: str, permission_id: int) -> Result[Role]:
        ...
        try:
            ...
            if not self.permission_service:
                return Failure(AuthorizationServiceError("Permission service not available"))
                
            permission_result = await self.permission_service.get_by_id(str(permission_id))
            if not permission_result:
                return Failure(AuthorizationServiceError(f"Permission {permission_id} not found"))
            ...
            return Failure(AuthorizationServiceError(f"Error adding permission to role: {str(e)}"))
    ...
    async def add_user(self, role_id: str, user_id: str) -> Result[Role]:
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error adding user to role: {str(e)}"))
...
class PermissionService(UnoEntityService[Permission]):
    ...
    async def find_by_meta_type(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error finding permissions: {str(e)}"))
    ...
    async def find_by_meta_type_and_operation(
        ...
        try:
            repository = cast(PermissionRepository, self.repository)
            result = await repository.find_by_meta_type_and_operation(meta_type_id, operation)
            return Success(result)
        except Exception as e:
            self.logger.error(f"Error finding permission by meta type and operation: {e}")
            return Failure(AuthorizationServiceError(f"Error finding permission: {str(e)}"))
...
class ResponsibilityRoleService(UnoEntityService[ResponsibilityRole]):
    ...
    async def find_by_name(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error finding responsibility role: {str(e)}"))
    ...
    async def find_by_tenant(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error finding responsibility roles: {str(e)}"))
    ...
    async def get_with_relationships(self, id: str) -> Result[ResponsibilityRole]:
        ...
        try:
            ...
            if not result:
                return Failure(AuthorizationServiceError(f"Responsibility role {id} not found"))
                
            return Success(result)
        except Exception as e:
            self.logger.error(f"Error getting responsibility role with relationships: {e}")
            return Failure(AuthorizationServiceError(f"Error getting responsibility role: {str(e)}"))
...
class TenantService(UnoEntityService[Tenant]):
    ...
    async def find_by_type(
        ...
        try:
            ...
            return Failure(AuthorizationServiceError(f"Error finding tenants: {str(e)}"))
    ...
    async def add_user(self, tenant_id: str, user_id: str) -> Result[Tenant]:
        ...
        try:
            ...
            if not tenant_result:
                return Failure(AuthorizationServiceError(f"Tenant {tenant_id} not found"))
            ...
            return Failure(AuthorizationServiceError(f"Error adding user to tenant: {str(e)}"))