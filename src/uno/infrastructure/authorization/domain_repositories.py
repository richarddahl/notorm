...
class UserRepository(UnoDBRepository[User]):
    ...
    async def find_by_group(
        ...
        default_group_users = await self.list(
    ...
    async def get_with_relationships(
        self, id: str, group_repo=None, role_repo=None, tenant_repo=None
    ) -> Optional[User]:
        """
...
class GroupRepository(UnoDBRepository[Group]):
    ...
    async def find_by_name(self, name: str, tenant_id: str) -> Optional[Group]:
        """
    ...
    async def get_with_relationships(
        self, id: str, user_repo=None, tenant_repo=None
    ) -> Optional[Group]:
        """
...
class RoleRepository(UnoDBRepository[Role]):
    ...
    async def find_by_name(self, name: str, tenant_id: str) -> Optional[Role]:
        """
    ...
    async def get_with_relationships(
        ...
        if responsibility_repo and role.responsibility_role_id:
            role.responsibility = await responsibility_repo.get(
                role.responsibility_role_id
            )
...
class TenantRepository(UnoDBRepository[Tenant]):
    ...
    async def get_with_relationships(
        self, id: str, user_repo=None, group_repo=None, role_repo=None
    ) -> Optional[Tenant]:
        """
