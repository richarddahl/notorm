...
class AESEncryption:
    ...
    def _encrypt_gcm(self, data: str, context: dict[str, Any] | None = None) -> str:
        """
    ...
    def _decrypt_gcm(self, data: str, context: dict[str, Any] | None = None) -> str:
        """
    ...
    def _encrypt_cbc(self, data: str, context: dict[str, Any] | None = None) -> str:
        """
    ...
    def _decrypt_cbc(self, data: str, context: dict[str, Any] | None = None) -> str:
        """
