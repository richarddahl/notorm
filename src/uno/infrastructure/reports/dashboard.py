...
async def create_dashboard(
    ...
    session: AsyncSession = Depends(get_db_session),
    template_service: ReportTemplateService = Depends(
        inject_dependency(ReportTemplateService)
    ),
):
...
async def get_dashboard_data(
    ...
    dashboard = {"id": dashboard_id, "report_ids": ["r-1001", "r-1002", "r-1003"]}
...
async def export_dashboard(
    ...
    if format.lower() == "pdf":
        ...
        return StreamingResponse(
            ...
            headers={
                "Content-Disposition": f"attachment; filename=dashboard_{dashboard_id}.pdf"
            },
        )
        ...
        return StreamingResponse(
            ...
            headers={
                "Content-Disposition": f"attachment; filename=dashboard_{dashboard_id}.xlsx"
            },
        )
    else:
        raise HTTPException(
