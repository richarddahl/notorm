...
class SQLConfig(BaseModel):
    ...
    def __init_subclass__(cls, **kwargs) -> None:
        ...
        Raises:
            BaseError: If a subclass with the same name already exists in the registry
        """
    ...
    def emit_sql(self, connection: Optional[Connection] = None) -> None:
        ...
        Raises:
            BaseError: If SQL emission fails
        """
        ...
        try:
            ...
            raise BaseError(f"Failed to emit SQL: {e}", "SQL_EMISSION_ERROR")
