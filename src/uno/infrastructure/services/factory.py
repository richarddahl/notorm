...
import logging
from typing import (
    Dict, Any, Type, TypeVar, Optional, Generic, cast, Callable, 
    get_type_hints, List, Tuple, Union
)
...
class ServiceFactory:
    ...
    def create_service(
        ...
        **kwargs
        ...
        Raises:
            UnoError: If service creation fails
        """
        try:
            ...
            self._logger.error(f"Error creating service {service_type.__name__}: {str(e)}")
            raise UnoError(
    ...
    def create_application_service(
        ...
        **kwargs
        ...
        return cast(
            ApplicationServiceProtocol,
            self.create_service(service_type, **kwargs)
        )
    ...
    def create_event_publisher(
        ...
        **kwargs
        ...
        return cast(
            DomainEventPublisherProtocol,
            self.create_service(EventPublisher, **kwargs)
        )
    ...
    def get_cached_crud_service(
        ...
        **kwargs
        ...
        return cast(CrudServiceProtocol[EntityT], self._service_cache[(CrudService, key)])
...
def create_aggregate_service(
    ...
    **kwargs
    ...
    Returns:
        The aggregate CRUD service
    """
    return get_service_factory().create_aggregate_service(entity_type, repository, **kwargs)
