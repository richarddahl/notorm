...
import functools
import pickle
from typing import Any, Dict, List, Tuple, Optional, Union, Set, Callable, TypeVar, Generic
...
def get_function_cache_key(func: callable, args: Tuple, kwargs: Dict[str, Any], 
    ...
    if not args and not kwargs:
        func_id = id(func)  # Use function id as it's faster than computing qualified name
