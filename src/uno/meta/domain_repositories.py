...
class MetaTypeRepository(UnoDBRepository[MetaType]):
    ...
    async def create_meta_type(self, id: str, name: Optional[str] = None, description: Optional[str] = None) -> MetaType:
        """
    ...
    async def get_with_records(self, id: str, record_limit: int = 100) -> Optional[MetaType]:
        """
...
class MetaRecordRepository(UnoDBRepository[MetaRecord]):
    ...
    async def find_by_meta_type(self, meta_type_id: str, limit: int = 100) -> List[MetaRecord]:
        """
    ...
    async def get_with_meta_type(self, id: str, meta_type_repo=None) -> Optional[MetaRecord]:
        """
