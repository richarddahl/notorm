...
class CodeGenerator:
    ...
    def _generate_entity(
        ...
        try:
            ...
            entity_relationships = self._find_entity_relationships(entity, relationships, entity_map)
    ...
    def _find_entity_relationships(
        ...
        for relationship in relationships:
            ...
            entity_relationships.append({
                ...
                "is_source": is_source,
                "is_target": is_target,
                "is_many": relationship.type in ("one-to-many", "many-to-many") or 
                          (relationship.type == "many-to-one" and is_source)
            })
