...
if TYPER_AVAILABLE:
    ...
    def generate_model_command(
        ...
        fields_file: Annotated[Optional[Path], typer.Option(help="JSON file with field definitions")] = None,
        fields_json: Annotated[Optional[str], typer.Option(help="JSON string with field definitions")] = None,
        ...
        include_schema: Annotated[bool, typer.Option(help="Include schema class")] = True,
        schema_name: Annotated[Optional[str], typer.Option(help="Schema class name")] = None,
        timestamps: Annotated[bool, typer.Option(help="Include timestamp fields")] = True,
        soft_delete: Annotated[bool, typer.Option(help="Include soft delete field")] = False,
        verbose: Annotated[int, typer.Option("--verbose", "-v", count=True, help="Verbosity level")] = 0,
    ):
        """Generate a UnoModel class."""
    ...
    def generate_repository_command(
        ...
        include_query_methods: Annotated[bool, typer.Option(help="Include query methods")] = True,
        include_bulk_methods: Annotated[bool, typer.Option(help="Include bulk methods")] = True,
        filters_file: Annotated[Optional[Path], typer.Option(help="JSON file with filter definitions")] = None,
        verbose: Annotated[int, typer.Option("--verbose", "-v", count=True, help="Verbosity level")] = 0,
    ):
    ...
    def generate_api_command(
        ...
        model_name: Annotated[str, typer.Argument(help="Model class name")],
        schema_name: Annotated[Optional[str], typer.Option(help="Schema class name")] = None,
        repository_name: Annotated[Optional[str], typer.Option(help="Repository class name")] = None,
        output_file: Annotated[Optional[Path], typer.Option(help="Output file path")] = None,
        id_type: Annotated[str, typer.Option(help="ID field type")] = "str",
        ...
        include_crud: Annotated[bool, typer.Option(help="Include CRUD endpoints")] = True,
        include_pagination: Annotated[bool, typer.Option(help="Include pagination")] = True,
        include_filtering: Annotated[bool, typer.Option(help="Include filtering")] = True,
        include_validation: Annotated[bool, typer.Option(help="Include validation")] = True,
        config_file: Annotated[Optional[Path], typer.Option(help="JSON file with endpoint configuration")] = None,
        verbose: Annotated[int, typer.Option("--verbose", "-v", count=True, help="Verbosity level")] = 0,
    ):
    ...
    def setup_parser(subparsers):
        ...
        # Model command
        model_parser = generate_subparsers.add_parser("model", help="Generate a UnoModel class")
        model_parser.add_argument("name", help="Model class name")
        model_parser.add_argument("--fields-file", type=str, help="JSON file with field definitions")
        model_parser.add_argument("--fields-json", type=str, help="JSON string with field definitions")
        ...
        model_parser.add_argument("--include-schema", action="store_true", help="Include schema class")
        model_parser.add_argument("--schema-name", type=str, help="Schema class name")
        model_parser.add_argument("--timestamps", action="store_true", help="Include timestamp fields")
        model_parser.add_argument("--soft-delete", action="store_true", help="Include soft delete field")
        model_parser.add_argument("-v", "--verbose", action="count", default=0, help="Verbosity level")
        
        # Repository command
        repo_parser = generate_subparsers.add_parser("repository", help="Generate a repository class")
        ...
        repo_parser.add_argument("--id-type", type=str, default="str", help="ID field type")
        repo_parser.add_argument("--include-crud", action="store_true", help="Include CRUD methods")
        repo_parser.add_argument("--include-query-methods", action="store_true", help="Include query methods")
        repo_parser.add_argument("--include-bulk-methods", action="store_true", help="Include bulk methods")
        repo_parser.add_argument("--filters-file", type=str, help="JSON file with filter definitions")
        repo_parser.add_argument("-v", "--verbose", action="count", default=0, help="Verbosity level")
        
        # API command
        api_parser = generate_subparsers.add_parser("api", help="Generate API endpoints")
        ...
        api_parser.add_argument("--repository-name", type=str, help="Repository class name")
        api_parser.add_argument("--output-file", type=str, help="Output file path")
        api_parser.add_argument("--id-type", type=str, default="str", help="ID field type")
        api_parser.add_argument("--prefix", type=str, help="API path prefix")
        api_parser.add_argument("--tag", type=str, help="API tag")
        api_parser.add_argument("--include-crud", action="store_true", help="Include CRUD endpoints")
        api_parser.add_argument("--include-pagination", action="store_true", help="Include pagination")
        api_parser.add_argument("--include-filtering", action="store_true", help="Include filtering")
        api_parser.add_argument("--include-validation", action="store_true", help="Include validation")
        api_parser.add_argument("--config-file", type=str, help="JSON file with endpoint configuration")
        api_parser.add_argument("-v", "--verbose", action="count", default=0, help="Verbosity level")
        
        # CRUD command
        crud_parser = generate_subparsers.add_parser("crud", help="Generate a complete CRUD setup")
        crud_parser.add_argument("name", help="Base name")
        crud_parser.add_argument("--output-dir", type=str, help="Output directory")
        crud_parser.add_argument("--id-type", type=str, default="str", help="ID field type")
        crud_parser.add_argument("--fields-file", type=str, help="JSON file with field definitions")
        crud_parser.add_argument("-v", "--verbose", action="count", default=0, help="Verbosity level")
    ...
    def _handle_crud_command(args):
        ...
        try:
            ...
            logger.info(f"Generated CRUD for {args.name} in {getattr(args, 'output_dir', 'current directory')}")
        except Exception as e:
            logger.error(f"Error generating CRUD: {str(e)}")
            sys.exit(1)