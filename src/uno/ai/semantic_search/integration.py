...
import logging
from typing import List, Dict, Any, Optional, Type, Callable, TypeVar, Generic, Protocol, Union
from uuid import UUID

from uno.ai.semantic_search.engine import SemanticSearchEngine
from uno.core.events import EventBus, subscribe, Event
...
class EntityDeletedEvent(Event):
