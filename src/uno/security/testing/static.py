...
""")
                    ...
                    for file_result in data:
                        ...
                        for message in file_result.get("messages", []):
                            ...
                            if rule_id.startswith("security/"):
                                ...
                                severity = "high" if severity_value == 2 else "medium" if severity_value == 1 else "low"
    ...
    def _has_javascript_files(self, target: str) -> bool:
        ...
        if os.path.isfile(target):
            return target.endswith(".js") or target.endswith(".jsx") or target.endswith(".ts") or target.endswith(".tsx")
