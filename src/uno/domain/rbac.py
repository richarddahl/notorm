...
from uno.domain.authorization import Permission, Role, AuthorizationService, get_authorization_service
...
class RbacService:
    ...
    def __init__(self, authorization_service: Optional[AuthorizationService] = None):
        ...
        """
        self.authorization_service = authorization_service or get_authorization_service()
    ...
    def create_user(self, user_id: str, roles: Optional[List[str]] = None, permissions: Optional[List[str]] = None) -> User:
        """
        Create a new user.
    ...
    def update_user(self, user_id: str, roles: Optional[List[str]] = None, permissions: Optional[List[str]] = None) -> Optional[User]:
        """
    ...
    async def authorize_user(self, user_id: str, resource: str, action: str, target: Optional[Any] = None) -> bool:
        """
    ...
    async def authorize_user_or_raise(self, user_id: str, resource: str, action: str, target: Optional[Any] = None) -> None:
        """
        ...
        if not await self.authorize_user(user_id, resource, action, target):
            ...
            raise AuthorizationError(f"User {user_id} is not authorized to {action} {resource}")
