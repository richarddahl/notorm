...
class CreateEntityCommandHandler(
    CommandHandler[CreateEntityCommand, EntityT], Generic[EntityT]
):
...
class UpdateEntityCommandHandler(
    CommandHandler[UpdateEntityCommand, EntityT], Generic[EntityT]
):
...
class DeleteEntityCommandHandler(
    CommandHandler[DeleteEntityCommand, bool], Generic[EntityT]
):
...
class CreateAggregateCommandHandler(
    CommandHandler[CreateAggregateCommand, AggregateT], Generic[AggregateT]
):
    ...
    async def _handle(
        self, command: CreateAggregateCommand, uow: UnitOfWork
    ) -> AggregateT:
        """
...
class UpdateAggregateCommandHandler(
    CommandHandler[UpdateAggregateCommand, AggregateT], Generic[AggregateT]
):
    ...
    async def _handle(
        self, command: UpdateAggregateCommand, uow: UnitOfWork
    ) -> AggregateT:
        """
...
class DeleteAggregateCommandHandler(
    CommandHandler[DeleteAggregateCommand, bool], Generic[AggregateT]
):
...
class BatchCommandHandler(CommandHandler[BatchCommand, BatchCommandResult]):
    ...
    async def _handle(
        self, command: BatchCommand, uow: UnitOfWork
    ) -> BatchCommandResult:
        """
...
class TransactionCommandHandler(
    CommandHandler[TransactionCommand, List[CommandResult]]
):
    ...
    async def _handle(
        self, command: TransactionCommand, uow: UnitOfWork
    ) -> List[CommandResult]:
        """
