...
from uno.sql.emitters.vector import VectorSQLEmitter, VectorConfig, VectorIntegrationEmitter
...
async def vector_search_example():
    ...
    # Create a RAG prompt
    system_prompt = "You are a helpful assistant that answers questions about vector search."
...
def setup_vector_search_example():
    ...
    print(f"Generated {len(integration_statements)} SQL statements for graph integration")
