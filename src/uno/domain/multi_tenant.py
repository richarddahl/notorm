...
from uno.domain.authorization import Permission, AuthorizationService, AuthorizationPolicy, TenantPolicy
...
class TenantRbacService(RbacService):
    ...
    def create_tenant(self, tenant_id: str, name: str, metadata: Optional[Dict[str, Any]] = None) -> Tenant:
        """
        Create a new tenant.
    ...
    def update_tenant(self, tenant_id: str, name: Optional[str] = None, active: Optional[bool] = None, metadata: Optional[Dict[str, Any]] = None) -> Optional[Tenant]:
        """
        Update a tenant.
    ...
    def create_role(self, name: str, permissions: Optional[List[str]] = None, tenant_id: Optional[str] = None) -> Role:
        """
    ...
    def update_role(self, name: str, permissions: List[str], tenant_id: Optional[str] = None) -> Optional[Role]:
        """
    ...
    def create_user(self, user_id: str, roles: Optional[List[str]] = None, permissions: Optional[List[str]] = None, tenant_id: Optional[str] = None) -> User:
        """
        ...
        if tenant_id is not None:
            ...
            if user_id in self._tenant_users[tenant_id]:
                raise ValueError(f"User already exists in tenant {tenant_id}: {user_id}")
    ...
    def add_user_to_tenant(self, user_id: str, tenant_id: str, roles: Optional[List[str]] = None, permissions: Optional[List[str]] = None) -> bool:
        """
    ...
    def remove_user_from_tenant(self, user_id: str, tenant_id: str) -> bool:
        ...
        if tenant_id not in self._tenant_users or user_id not in self._tenant_users[tenant_id]:
            return False
    ...
    def has_permission(self, user_id: str, permission: str, tenant_id: Optional[str] = None) -> bool:
        """
    ...
    def get_user_permissions(self, user_id: str, tenant_id: Optional[str] = None) -> List[str]:
        """
    ...
    def create_service_context(self, user_id: str, tenant_id: Optional[str] = None) -> ServiceContext:
        """
    ...
    async def authorize_user(self, user_id: str, resource: str, action: str, target: Optional[Any] = None, tenant_id: Optional[str] = None) -> bool:
        """
        ...
        # Check authorization
        return await self.authorization_service.authorize(context, resource, action, target)
...
class MultiTenantAuthorizationService(AuthorizationService):
    ...
    def __init__(self, rbac_service: Optional[TenantRbacService] = None, logger: Optional[logging.Logger] = None):
        """
    ...
    def register_policy(self, policy: AuthorizationPolicy, tenant_id: Optional[str] = None) -> None:
        """
    ...
    def get_policy(self, resource: str, action: str, tenant_id: Optional[str] = None) -> Optional[AuthorizationPolicy]:
        """
    ...
    def register_tenant_ownership_policy(self, resource: str, action: str, tenant_id: str, owner_field: str = "owner_id") -> None:
        """
    ...
    def register_tenant_isolation_policy(self, resource: str, action: str, tenant_id: str, tenant_field: str = "tenant_id") -> None:
        """
