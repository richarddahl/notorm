...
warnings.warn(
    ...
    "Import from uno.core.base.error, uno.core.errors.result, etc. instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
class DomainError(BaseError):
    ...
    DEPRECATED: Use BaseError from uno.core.base.error instead.
    """
