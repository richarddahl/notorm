...
from typing import Any, Dict, Generic, List, Optional, Type, TypeVar, cast, Protocol, Union, Callable
...
class EntityService(ApplicationService, Generic[EntityT]):
    ...
    async def create(self, data: Dict[str, Any], context: ServiceContext) -> CommandResult:
        """
        Create a new entity.
    ...
    async def update(self, id: str, data: Dict[str, Any], context: ServiceContext) -> CommandResult:
        """
...
class AggregateService(ApplicationService, Generic[AggregateT]):
    ...
    async def update(self, id: str, version: int, data: Dict[str, Any], context: ServiceContext) -> CommandResult:
        """
    ...
    async def delete(self, id: str, version: Optional[int] = None, context: ServiceContext = None) -> CommandResult:
        """
        Delete an aggregate.
