...
class DateValueCreateDto(ValueBaseDto):
    ...
    value: Union[date, str] = Field(..., description="The date value in ISO format (YYYY-MM-DD)")
    ...
    def validate_date(self):
        ...
        if isinstance(self.value, str):
            try:
                ...
                raise ValueError(f"Invalid date format: {self.value}. Must be in ISO format (YYYY-MM-DD)")
        return self
...
class DateTimeValueCreateDto(ValueBaseDto):
    ...
    value: Union[datetime, str] = Field(..., description="The datetime value in ISO format")
    ...
    def validate_datetime(self):
        ...
        if isinstance(self.value, str):
            try:
                ...
                raise ValueError(f"Invalid datetime format: {self.value}. Must be in ISO format")
        return self
...
class TimeValueCreateDto(ValueBaseDto):
    ...
    value: Union[time, str] = Field(..., description="The time value in ISO format (HH:MM:SS)")
    ...
    def validate_time(self):
        ...
        if isinstance(self.value, str):
            try:
                ...
                raise ValueError(f"Invalid time format: {self.value}. Must be in ISO format (HH:MM:SS)")
        return self
...
class ValueFilterParams(BaseModel):
    ...
    value_type: Optional[str] = Field(None, description="Filter by value type")
