...
class FieldValidator(Validator):
    ...
    def min_length(self, obj: Any, field: str, min_length: int, result: ValidationResult) -> None:
        """
        ...
        if hasattr(obj, field) and getattr(obj, field) is not None:
            ...
            if isinstance(value, str) and len(value) < min_length:
                result.add_message(f"Field '{field}' must be at least {min_length} characters long")
    
    def max_length(self, obj: Any, field: str, max_length: int, result: ValidationResult) -> None:
        """
        ...
        if hasattr(obj, field) and getattr(obj, field) is not None:
            ...
            if isinstance(value, str) and len(value) > max_length:
                result.add_message(f"Field '{field}' must be at most {max_length} characters long")
    ...
    def range(
        ...
        if hasattr(obj, field) and getattr(obj, field) is not None:
            ...
            if isinstance(value, (int, float)) and (value < min_value or value > max_value):
                result.add_message(f"Field '{field}' must be between {min_value} and {max_value}")
    
    def pattern(self, obj: Any, field: str, pattern: str, result: ValidationResult) -> None:
        """
        ...
        if hasattr(obj, field) and getattr(obj, field) is not None:
            ...
            if isinstance(value, str) and not re.match(pattern, value):
                result.add_message(f"Field '{field}' does not match the required pattern")
...
class DataValidator:
    ...
    @staticmethod
    def min_length(data: Dict[str, Any], field: str, min_length: int) -> ValidationResult:
        """
    ...
    @staticmethod
    def max_length(data: Dict[str, Any], field: str, max_length: int) -> ValidationResult:
        """
