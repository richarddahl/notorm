...
class EntityByIdQueryHandler(
    QueryHandler[EntityByIdQuery[EntityT], Optional[EntityT]], Generic[EntityT]
):
...
class EntityListQueryHandler(
    QueryHandler[EntityListQuery[EntityT], List[EntityT]], Generic[EntityT]
):
...
class PaginatedEntityQueryHandler(
    QueryHandler[PaginatedEntityQuery[EntityT], PaginatedResult[EntityT]],
    Generic[EntityT],
):
    ...
    async def _handle(
        self, query: PaginatedEntityQuery[EntityT]
...
class SqlPaginatedQueryHandler(
    SqlQueryHandler[SqlPaginatedQuery, PaginatedResult[Dict[str, Any]], Any]
):
