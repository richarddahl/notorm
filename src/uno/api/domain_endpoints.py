...
from uno.core.errors import BaseError, ErrorCodes
...
async def list_resources(
    ...
    api_service: ApiResourceServiceProtocol = Depends(
        get_service(ApiResourceServiceProtocol)
    ),
):
...
async def remove_endpoint(
    ...
    result = await api_service.remove_endpoint_from_resource(
        resource_id=resource_id, endpoint_id=endpoint_id
    )
