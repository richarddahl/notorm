...
class SortField(BaseModel):
    ...
    name: str = Field(..., description="Field name")
    direction: SortDirection = Field(SortDirection.ASCENDING, description="Sort direction")
...
class FilterCondition(BaseModel):
    ...
    field: Optional[FilterField] = Field(None, description="Field condition, required if type is 'field'")
    group: Optional["FilterConditionGroup"] = Field(None, description="Group of conditions, required if type is 'group'")
...
class FilterRequest(BaseModel):
    ...
    include_count: bool = Field(True, description="Whether to include the total count of matching entities")
