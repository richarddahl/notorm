...
from .models import FilterCondition, FilterConditionGroup, FilterCriteria, FilterField, FilterOperator, SortDirection, SortField
            ...
            for sort_str in sort:
                try:
                    ...
                    sort_field = SortField(
                        name=field_name,
                        direction=SortDirection.ASCENDING if direction == "asc" else SortDirection.DESCENDING,
                    )
