...
from typing import Dict, List, Optional, Any, Protocol, Type, TypeVar, Generic, Union, Callable
...
from .domain_repositories import ApiResourceRepositoryProtocol, EndpointConfigRepositoryProtocol
...
class ApiResourceServiceProtocol(Service, Protocol):
    ...
    async def get_resource_by_path_prefix(self, path_prefix: str) -> Result[Optional[ApiResource]]:
        """
    ...
    async def get_resources_by_entity_type(self, entity_type_name: str) -> Result[List[ApiResource]]:
        """
    ...
    async def remove_endpoint_from_resource(self, resource_id: str, endpoint_id: str) -> Result[ApiResource]:
        """
...
class RepositoryAdapterService(RepositoryAdapterServiceProtocol):
    ...
    def create_adapter(
        ...
        Returns:
            A repository adapter instance
        """
        from .repository_adapter import RepositoryAdapter, ReadOnlyRepositoryAdapter, BatchRepositoryAdapter
    ...
    def _create_schema_manager(self, entity_type: Type[EntityT], schema_type: Type[SchemaT]) -> Any:
        """
        ...
        """
        class SchemaManager:
            def create_entity(self, entity_cls: Type[EntityT], data: Dict[str, Any]) -> EntityT:
            ...
            def entity_to_dto(self, entity: EntityT) -> SchemaT:
                ...
                return schema_type(**{k: getattr(entity, k) for k in entity.__dataclass_fields__})
