...
async def trigger_workflow_with_event() -> None:
    ...
    print(f"Dispatched CustomerCreatedEvent for premium NA customer {premium_na_event.name}")
    ...
    print(f"Dispatched CustomerCreatedEvent for standard NA customer {standard_na_event.name}")
    ...
    print(f"Dispatched CustomerCreatedEvent for premium EU customer {premium_eu_event.name}")
...
async def run_query_integration_example() -> None:
    ...
    try:
        ...
        logger.info("Creating complex graph query for premium North American customers...")
        ...
        logger.info("This will demonstrate how the QueryExecutor evaluates records against complex conditions")
        ...
        logger.info("3. Demonstrated selective event processing based on query execution")
