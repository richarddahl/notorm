...
class WorkflowDefRepository(UnoDBRepository[WorkflowDef]):
    ...
    async def create_workflow(
        ...
        **kwargs
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error creating workflow: {str(e)}"))
    ...
    async def find_active_workflows(self) -> Result[List[WorkflowDef]]:
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error finding active workflows: {str(e)}"))
...
class WorkflowConditionRepository(UnoDBRepository[WorkflowCondition]):
    ...
    async def find_by_workflow(self, workflow_id: str) -> Result[List[WorkflowCondition]]:
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error finding conditions: {str(e)}"))
    ...
    async def create_condition(
        ...
        **kwargs
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error creating condition: {str(e)}"))
...
class WorkflowRecipientRepository(UnoDBRepository[WorkflowRecipient]):
    ...
    async def find_by_workflow(self, workflow_id: str) -> Result[List[WorkflowRecipient]]:
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error finding recipients: {str(e)}"))
    ...
    async def create_recipient(
        ...
        **kwargs
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error creating recipient: {str(e)}"))
...
class WorkflowExecutionRepository(UnoDBRepository[WorkflowExecutionRecord]):
    ...
    async def find_by_workflow(self, workflow_id: str, limit: int = 100) -> Result[List[WorkflowExecutionRecord]]:
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error finding execution records: {str(e)}"))
    ...
    async def create_execution_record(
        ...
        **kwargs
        ...
        try:
            ...
            return Failure(WorkflowRepositoryError(f"Error creating execution record: {str(e)}"))
    ...
    async def update_execution_status(
        ...
        try:
            ...
            if not record:
                return Failure(WorkflowExecutionError(f"Execution record {execution_id} not found"))
            ...
            if status in terminal_statuses:
                ...
                if record.executed_at and record.completed_at:
                    record.execution_time = (record.completed_at - record.executed_at).total_seconds()
            ...
            return Failure(WorkflowRepositoryError(f"Error updating execution status: {str(e)}"))