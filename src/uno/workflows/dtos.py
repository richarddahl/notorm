...
class WorkflowTriggerBaseDto(BaseModel):
    ...
    entity_type: str = Field(..., description="Type of entity that triggers the workflow")
    operation: WorkflowDBEventEnum = Field(..., description="Database operation that triggers the workflow")
    field_conditions: Dict[str, Any] = Field(default_factory=dict, description="Field conditions to filter events")
    priority: int = Field(100, description="Priority of the trigger (lower numbers run first)")
...
class WorkflowTriggerUpdateDto(BaseModel):
    ...
    entity_type: Optional[str] = Field(None, description="Type of entity that triggers the workflow")
    operation: Optional[WorkflowDBEventEnum] = Field(None, description="Database operation that triggers the workflow")
    field_conditions: Optional[Dict[str, Any]] = Field(None, description="Field conditions to filter events")
    priority: Optional[int] = Field(None, description="Priority of the trigger (lower numbers run first)")
...
class WorkflowTriggerFilterParams(BaseModel):
    ...
    operation: Optional[WorkflowDBEventEnum] = Field(None, description="Filter by operation")
...
class WorkflowConditionBaseDto(BaseModel):
    ...
    condition_type: WorkflowConditionTypeEnum = Field(..., description="Type of condition")
    condition_config: Dict[str, Any] = Field(default_factory=dict, description="Configuration for the condition")
    query_id: Optional[str] = Field(None, description="ID of the query for query match conditions")
...
class WorkflowConditionUpdateDto(BaseModel):
    ...
    condition_type: Optional[WorkflowConditionTypeEnum] = Field(None, description="Type of condition")
    condition_config: Optional[Dict[str, Any]] = Field(None, description="Configuration for the condition")
    query_id: Optional[str] = Field(None, description="ID of the query for query match conditions")
    name: Optional[str] = Field(None, description="Name of the condition")
    description: Optional[str] = Field(None, description="Description of the condition")
    order: Optional[int] = Field(None, description="Order in which the condition is evaluated")
...
class WorkflowConditionFilterParams(BaseModel):
    ...
    workflow_id: Optional[str] = Field(None, description="Filter by workflow ID")
    condition_type: Optional[WorkflowConditionTypeEnum] = Field(None, description="Filter by condition type")
...
class WorkflowRecipientBaseDto(BaseModel):
    ...
    recipient_type: WorkflowRecipientTypeEnum = Field(..., description="Type of recipient")
    ...
    notification_config: Dict[str, Any] = Field(default_factory=dict, description="Configuration for notifications")
...
class WorkflowRecipientUpdateDto(BaseModel):
    ...
    recipient_type: Optional[WorkflowRecipientTypeEnum] = Field(None, description="Type of recipient")
    recipient_id: Optional[str] = Field(None, description="ID of the recipient")
    name: Optional[str] = Field(None, description="Display name for the recipient")
    notification_config: Optional[Dict[str, Any]] = Field(None, description="Configuration for notifications")
    action_id: Optional[str] = Field(None, description="ID of the associated action")
...
class WorkflowRecipientFilterParams(BaseModel):
    ...
    workflow_id: Optional[str] = Field(None, description="Filter by workflow ID")
    recipient_type: Optional[WorkflowRecipientTypeEnum] = Field(None, description="Filter by recipient type")
...
class WorkflowActionBaseDto(BaseModel):
    ...
    action_config: Dict[str, Any] = Field(default_factory=dict, description="Configuration for the action")
    ...
    retry_policy: Optional[Dict[str, Any]] = Field(None, description="Policy for retrying failed actions")
...
class WorkflowActionCreateDto(WorkflowActionBaseDto):
    ...
    recipients: Optional[List[WorkflowRecipientCreateDto]] = Field(None, description="Recipients for this action")

class WorkflowActionUpdateDto(BaseModel):
    """DTO for updating workflow actions."""
    action_type: Optional[WorkflowActionTypeEnum] = Field(None, description="Type of action")
    action_config: Optional[Dict[str, Any]] = Field(None, description="Configuration for the action")
    name: Optional[str] = Field(None, description="Name of the action")
    description: Optional[str] = Field(None, description="Description of the action")
    order: Optional[int] = Field(None, description="Order in which the action is executed")
...
class WorkflowActionViewDto(WorkflowActionBaseDto):
    ...
    id: str = Field(..., description="Unique identifier")
    workflow_id: str = Field(..., description="ID of the associated workflow")
    recipients: List[WorkflowRecipientViewDto] = Field(default_factory=list, description="Recipients for this action")
...
class WorkflowActionFilterParams(BaseModel):
    ...
    workflow_id: Optional[str] = Field(None, description="Filter by workflow ID")
    action_type: Optional[WorkflowActionTypeEnum] = Field(None, description="Filter by action type")
    is_active: Optional[bool] = Field(None, description="Filter by active status")
    name: Optional[str] = Field(None, description="Filter by name")
...
class WorkflowExecutionRecordBaseDto(BaseModel):
    ...
    workflow_id: str = Field(..., description="ID of the associated workflow")
    trigger_event_id: str = Field(..., description="ID of the event that triggered the workflow")
    status: WorkflowExecutionStatusEnum = Field(WorkflowExecutionStatusEnum.PENDING, description="Status of the execution")
    ...
    error: Optional[str] = Field(None, description="Error message if the workflow execution failed")
    context: Optional[Dict[str, Any]] = Field(None, description="Context data for the workflow execution")
    execution_time: Optional[float] = Field(None, description="Time taken to execute the workflow in milliseconds")
...
class WorkflowExecutionRecordUpdateDto(BaseModel):
    ...
    status: Optional[WorkflowExecutionStatusEnum] = Field(None, description="Status of the execution")
    completed_at: Optional[datetime] = Field(None, description="When the workflow execution completed")
    result: Optional[Dict[str, Any]] = Field(None, description="Result of the workflow execution")
    error: Optional[str] = Field(None, description="Error message if the workflow execution failed")
    context: Optional[Dict[str, Any]] = Field(None, description="Context data for the workflow execution")
...
class WorkflowExecutionRecordFilterParams(BaseModel):
    ...
    workflow_id: Optional[str] = Field(None, description="Filter by workflow ID")
    status: Optional[WorkflowExecutionStatusEnum] = Field(None, description="Filter by status")
    executed_after: Optional[datetime] = Field(None, description="Filter by executed after date")
    executed_before: Optional[datetime] = Field(None, description="Filter by executed before date")
    trigger_event_id: Optional[str] = Field(None, description="Filter by trigger event ID")
...
class WorkflowDefBaseDto(BaseModel):
    ...
    status: WorkflowStatusEnum = Field(WorkflowStatusEnum.DRAFT, description="Status of the workflow")
...
class WorkflowDefCreateDto(WorkflowDefBaseDto):
    ...
    triggers: Optional[List[WorkflowTriggerCreateDto]] = Field(None, description="Triggers for this workflow")
    conditions: Optional[List[WorkflowConditionCreateDto]] = Field(None, description="Conditions for this workflow")
    actions: Optional[List[WorkflowActionCreateDto]] = Field(None, description="Actions for this workflow")
    recipients: Optional[List[WorkflowRecipientCreateDto]] = Field(None, description="Global recipients for this workflow")

class WorkflowDefUpdateDto(BaseModel):
    """DTO for updating workflow definitions."""
    name: Optional[str] = Field(None, description="Name of the workflow")
    description: Optional[str] = Field(None, description="Description of the workflow")
    status: Optional[WorkflowStatusEnum] = Field(None, description="Status of the workflow")
...
class WorkflowDefViewDto(WorkflowDefBaseDto):
    ...
    id: str = Field(..., description="Unique identifier")
    triggers: List[WorkflowTriggerViewDto] = Field(default_factory=list, description="Triggers for this workflow")
    conditions: List[WorkflowConditionViewDto] = Field(default_factory=list, description="Conditions for this workflow")
    actions: List[WorkflowActionViewDto] = Field(default_factory=list, description="Actions for this workflow")
    recipients: List[WorkflowRecipientViewDto] = Field(default_factory=list, description="Global recipients for this workflow")
...
class WorkflowDefFilterParams(BaseModel):
    ...
    entity_type: Optional[str] = Field(None, description="Filter by entity type (via triggers)")
    operation: Optional[WorkflowDBEventEnum] = Field(None, description="Filter by operation (via triggers)")
    contains_action_type: Optional[WorkflowActionTypeEnum] = Field(None, description="Filter by containing a specific action type")
...
class WorkflowEventDto(BaseModel):
    ...
    table_name: str = Field(..., description="Name of the table that triggered the event")
    schema_name: str = Field(..., description="Name of the schema that contains the table")
    operation: WorkflowDBEventEnum = Field(..., description="Database operation that triggered the event")
    ...
    context: Optional[Dict[str, Any]] = Field(None, description="Context data for the event")
...
WorkflowActionViewDto.update_forward_refs()
WorkflowDefViewDto.update_forward_refs()