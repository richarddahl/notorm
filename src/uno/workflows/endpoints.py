...
@router.get("/{workflow_id}/executions/{execution_id}", response_model=WorkflowExecutionLogSchema)
...
@router.post("/{workflow_id}/executions/{execution_id}/actions/{action_id}/retry", response_model=Dict[str, bool])
