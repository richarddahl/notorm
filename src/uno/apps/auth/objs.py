...
from uno.record.mixins import GeneralMixin
...
from uno.apps.auth.mixins import UserMixin
...
class User(UnoRecord, UserMixin):
...
class Group(UnoRecord, GeneralMixin):
    table_def = UnoTableDef(
        table_name="group",
        meta_data=meta_data,
        args=[
...
class Role(UnoRecord, GeneralMixin):
    table_def = UnoTableDef(
        table_name="role",
        meta_data=meta_data,
        args=[
...
class Tenant(UnoRecord, GeneralMixin):
    table_def = UnoTableDef(
        table_name="tenant",
        meta_data=meta_data,
        args=[
