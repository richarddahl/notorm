...
class TestingContainer:
    ...
    def __init__(self):
        ...
        self._original_config = inject.get_injector() if inject.is_configured() else None
...
def configure_test_container(config: Optional[Dict[Type, Any]] = None) -> TestingContainer:
    """
