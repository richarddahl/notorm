...
class ReportTemplateAlreadyExistsError(UnoError):
...
class ReportTemplateInvalidError(UnoError):
...
# Field errors
class ReportFieldNotFoundError(UnoError):
...
class ReportFieldInvalidError(UnoError):
...
# Execution errors
class ReportExecutionFailedError(UnoError):
...
class ReportExecutionNotFoundError(UnoError):
...
# Output errors
class ReportOutputFormatInvalidError(UnoError):
...
class ReportOutputDeliveryFailedError(UnoError):
...
# Trigger errors
class ReportTriggerNotFoundError(UnoError):
...
class ReportTriggerInvalidError(UnoError):
