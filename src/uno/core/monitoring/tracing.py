...
class Tracer:
    ...
    def __init__(
        ...
        self._sampler_func: Callable[[str, Optional[str], str], bool] = lambda trace_id, parent_id, name: True
    ...
    async def dispatch(
        ...
        try:
            async with span_context as span:
                ...
                add_error_context(request_id=request_id, path=path, method=request.method)
