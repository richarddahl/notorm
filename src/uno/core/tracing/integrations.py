...
from uno.core.logging.framework import get_logger, LogConfig, add_context as add_logging_context
from uno.core.metrics.framework import timed, MetricsMiddleware, get_metrics_registry, MetricsConfig
        ...
        async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            for arg_name, arg_value in kwargs.items():
                if arg_name in ["query", "statement", "sql"]:
                    if isinstance(arg_value, str):
                        attributes["db.statement"] = arg_value[:1000]  # Truncate long queries
            ...
            async with tracer.create_span(
                ...
                try:
                    ...
                    span.attributes["db.execution_time_ms"] = (end_time - start_time) * 1000
