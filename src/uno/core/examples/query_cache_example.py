...
async def basic_caching_example():
    ...
    print(
        f"Cache stats: {stats['performance']['hits']} hits, {stats['performance']['misses']} misses"
    )
...
async def cached_queries_example():
    ...
    async with enhanced_pool_session() as session:
        ...
        stats = cache.get_stats()
        print(
            f"Updated cache stats: {stats['performance']['hits']} hits, {stats['performance']['misses']} misses"
        )
...
async def advanced_features_example():
    ...
    print(
        f"  Cascading invalidations: {stats['invalidation']['cascading_invalidations']}"
    )
