...
BaseError, Result pattern, and contextual error information.
"""
...
class UserService:
    ...
    def validate_user_data(self, user_data: Dict[str, Any]) -> Result[Dict[str, Any]]:
        ...
        try:
            ...
            validators = {"email": [validate_email], "password": [validate_password]}
    ...
    async def authenticate_user(
        ...
        return Success({"id": "usr_123", "username": username, "is_admin": True})
