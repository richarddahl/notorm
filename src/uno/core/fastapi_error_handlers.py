...
from uno.core.errors.base import UnoError, ErrorCode, ErrorCategory, ErrorSeverity
...
def setup_error_handlers(app: FastAPI, include_tracebacks: bool = False) -> None:
    ...
    async def uno_error_handler(request: Request, exc: UnoError) -> JSONResponse:
        ...
        response_content = _build_error_response(exc, include_traceback=include_tracebacks)
    ...
    async def uno_validation_error_handler(request: Request, exc: UnoValidationError) -> JSONResponse:
        """
...
def _build_error_response(exc: UnoError, include_traceback: bool = False) -> Dict[str, Any]:
    """
