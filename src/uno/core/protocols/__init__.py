...
class Command(Protocol, Generic[T_Result]):
    """
...
class Query(Protocol, Generic[T_Result]):
    """
...
T_Command = TypeVar('T_Command')

class CommandHandler(Protocol, Generic[T_Command, T_Result]):
    """
...
class QueryHandler(Protocol, Generic[T_Query, T_Result]):
    """
