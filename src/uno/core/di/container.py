...
class ServiceRegistration:
    ...
    def __init__(
        ...
        self.implementation = (
            implementation if implementation is not None else service_type
        )
...
class Container(ContainerProtocol):
    ...
    def _create_instance(self, registration: ServiceRegistration, **kwargs: Any) -> Any:
        ...
        constructor_params = self._get_constructor_params(
            registration.implementation, all_kwargs
        )

        return registration.implementation(**constructor_params)

    def _get_constructor_params(
        self, implementation: Type, explicit_params: dict[str, Any]
    ) -> dict[str, Any]:
        """
