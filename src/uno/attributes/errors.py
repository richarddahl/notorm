...
class AttributeNotFoundError(UnoError):
...
class AttributeTypeNotFoundError(UnoError):
...
class AttributeInvalidDataError(UnoError):
...
class AttributeTypeInvalidDataError(UnoError):
...
class AttributeValueError(UnoError):
...
class AttributeServiceError(UnoError):
...
class AttributeTypeServiceError(UnoError):
...
class AttributeValidationError(UnoError):
...
class AttributeGraphError(UnoError):
