    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "value_ids": [
                    "01H3ZEVKY6ZH3F41K5GS77PJ1Z",
                    "01H3ZEVKY9PDSF51K5HS77PJ2A",
                ],
            }
        }
    )
...
class AttributeResponseDTO(BaseModel):
    ...
    values: Optional[List[dict]] = Field(
        None, description="Values associated with this attribute"
    )
...
class AttributeTypeCreateDTO(BaseModel):
    ...
    parent_id: Optional[str] = Field(
        None, description="ID of the parent attribute type"
    )
    required: bool = Field(
        False, description="Whether attributes of this type are required"
    )
    multiple_allowed: bool = Field(
        False, description="Whether multiple values are allowed"
    )
    comment_required: bool = Field(False, description="Whether a comment is required")
    display_with_objects: bool = Field(
        False, description="Whether to display with objects"
    )
    initial_comment: Optional[str] = Field(None, description="Initial comment template")
    meta_type_ids: Optional[List[str]] = Field(
        None, description="IDs of meta types this attribute type applies to"
    )
    value_type_ids: Optional[List[str]] = Field(
...
class AttributeTypeUpdateDTO(BaseModel):
    ...
    text: Optional[str] = Field(
        None, description="Text description of the attribute type"
    )
    parent_id: Optional[str] = Field(
        None, description="ID of the parent attribute type"
    )
    required: Optional[bool] = Field(
        None, description="Whether attributes of this type are required"
    )
    multiple_allowed: Optional[bool] = Field(
        None, description="Whether multiple values are allowed"
    )
    comment_required: Optional[bool] = Field(
        None, description="Whether a comment is required"
    )
    display_with_objects: Optional[bool] = Field(
        None, description="Whether to display with objects"
    )
    initial_comment: Optional[str] = Field(None, description="Initial comment template")
    meta_type_ids: Optional[List[str]] = Field(
        None, description="IDs of meta types this attribute type applies to"
...
class AttributeTypeResponseDTO(BaseModel):
    ...
    required: bool = Field(
        ..., description="Whether attributes of this type are required"
    )
    multiple_allowed: bool = Field(
    ...
    display_with_objects: bool = Field(
        ..., description="Whether to display with objects"
    )
    initial_comment: Optional[str] = Field(None, description="Initial comment template")
    created_at: str = Field(..., description="Creation timestamp")
    updated_at: str = Field(..., description="Last update timestamp")
    describes: Optional[List[dict]] = Field(
        None, description="Meta types this attribute type applies to"
    )
    value_types: Optional[List[dict]] = Field(
        None, description="Meta types allowed as values"
    )
...
def create_attribute_endpoints(
    ...
    async def create_attribute(data: AttributeCreateDTO, context=Depends(get_context)):
        ...
        response = AttributeResponseDTO(
            ...
            created_at=(
                created_attribute.created_at.isoformat()
                if created_attribute.created_at
                else None
            ),
            updated_at=(
                created_attribute.updated_at.isoformat()
                if created_attribute.updated_at
                else None
            ),
            values=(
                [
                    ...
                    for value in created_attribute.values
                ]
                if created_attribute.values
                else None
            ),
        )
    ...
    async def get_attribute(attribute_id: str, context=Depends(get_context)):
        # Get attribute from repository
        async with attribute_service.db_manager.get_enhanced_session() as session:
            result = await attribute_service.attribute_repository.get_by_id(
                attribute_id, session
            )
            ...
            if result.is_failure:
                ...
                if isinstance(error, AttributeNotFoundError):
                    status_code = status.HTTP_404_NOT_FOUND
                elif isinstance(error, AttributeInvalidDataError):
    ...
    async def update_attribute(
        attribute_id: str, data: AttributeUpdateDTO, context=Depends(get_context)
    ):
        # Get existing attribute
        async with attribute_service.db_manager.get_enhanced_session() as session:
            get_result = await attribute_service.attribute_repository.get_by_id(
                attribute_id, session
            )
            ...
            # Update attribute
            update_result = await attribute_service.attribute_repository.update(
                attribute, session
            )
            ...
            response = AttributeResponseDTO(
                ...
                created_at=(
                    updated_attribute.created_at.isoformat()
                    if updated_attribute.created_at
                    else None
                ),
                updated_at=(
                    updated_attribute.updated_at.isoformat()
                    if updated_attribute.updated_at
                    else None
                ),
                values=(
                    [
                        ...
                        for value in updated_attribute.values
                    ]
                    if updated_attribute.values
                    else None
                ),
            )
    ...
    async def add_attribute_values(
        attribute_id: str, value_ids: List[str], context=Depends(get_context)
    ):
        # Get values
        values = []
    ...
    async def delete_attribute(attribute_id: str, context=Depends(get_context)):
        # Delete attribute
        async with attribute_service.db_manager.get_enhanced_session() as session:
            result = await attribute_service.attribute_repository.delete(
                attribute_id, session
            )
    ...
    async def get_attributes_for_record(
        record_id: str, include_values: bool = True, context=Depends(get_context)
    ):
        # Get attributes
        result = await attribute_service.get_attributes_for_record(
            record_id, include_values
        )
...
def create_attribute_type_endpoints(
    ...
    async def create_attribute_type(
        data: AttributeTypeCreateDTO, context=Depends(get_context)
    ):
        ...
        response = AttributeTypeResponseDTO(
            ...
            created_at=(
                created_type.created_at.isoformat() if created_type.created_at else None
            ),
            updated_at=(
                created_type.updated_at.isoformat() if created_type.updated_at else None
            ),
            describes=(
                [
                    {
                    ...
                    for meta_type in created_type.describes
                ]
                if created_type.describes
                else None
            ),
            value_types=(
                [
                    ...
                    for meta_type in created_type.value_types
                ]
                if created_type.value_types
                else None
            ),
        )
    ...
    async def get_attribute_type(attribute_type_id: str, context=Depends(get_context)):
        # Get attribute type from repository
        async with attribute_type_service.db_manager.get_enhanced_session() as session:
            result = await attribute_type_service.attribute_type_repository.get_by_id(
                attribute_type_id, session
            )
            ...
            response = AttributeTypeResponseDTO(
                ...
                created_at=(
                    attribute_type.created_at.isoformat()
                    if attribute_type.created_at
                    else None
                ),
                updated_at=(
                    attribute_type.updated_at.isoformat()
                    if attribute_type.updated_at
                    else None
                ),
                describes=(
                    [
                ...
                value_types=(
                    [
                        ...
                        for meta_type in attribute_type.value_types
                    ]
                    if attribute_type.value_types
                    else None
                ),
            )
    ...
    async def update_attribute_type(
        ...
        async with attribute_type_service.db_manager.get_enhanced_session() as session:
            get_result = (
                await attribute_type_service.attribute_type_repository.get_by_id(
                    attribute_type_id, session
                )
            )
            ...
            update_result = (
                await attribute_type_service.attribute_type_repository.update(
            ...
            if data.meta_type_ids is not None:
                meta_type_result = (
                    await attribute_type_service.update_applicable_meta_types(
                        attribute_type_id, data.meta_type_ids
                    )
                )
            ...
            if data.value_type_ids is not None:
                value_type_result = (
                    await attribute_type_service.update_value_meta_types(
                        attribute_type_id, data.value_type_ids
                    )
                )
            ...
            response = AttributeTypeResponseDTO(
                ...
                created_at=(
                    updated_type.created_at.isoformat()
                    if updated_type.created_at
                    else None
                ),
                updated_at=(
                    updated_type.updated_at.isoformat()
                    if updated_type.updated_at
                    else None
                ),
                describes=(
                    [
                        ...
                        for meta_type in updated_type.describes
                    ]
                    if updated_type.describes
                    else None
                ),
                value_types=(
                    [
                        ...
                        for meta_type in updated_type.value_types
                    ]
                    if updated_type.value_types
                    else None
                ),
            )
    ...
    async def update_applicable_meta_types(
        attribute_type_id: str, meta_type_ids: List[str], context=Depends(get_context)
    ):
        # Update applicable meta types
        result = await attribute_type_service.update_applicable_meta_types(
            attribute_type_id, meta_type_ids
        )
        ...
        response = AttributeTypeResponseDTO(
            ...
            initial_comment=updated_type.initial_comment,
            created_at=(
                updated_type.created_at.isoformat() if updated_type.created_at else None
            ),
            updated_at=(
                updated_type.updated_at.isoformat() if updated_type.updated_at else None
            ),
            describes=(
                [
                    {
    ...
    async def update_value_meta_types(
        ...
        result = await attribute_type_service.update_value_meta_types(
            attribute_type_id, meta_type_ids
        )
    ...
    async def get_applicable_attribute_types(
        meta_type_id: str, context=Depends(get_context)
    ):
        # Get applicable attribute types
        result = await attribute_type_service.get_applicable_attribute_types(
            meta_type_id
        )
    ...
    async def delete_attribute_type(
        attribute_type_id: str, context=Depends(get_context)
    ):
        # Delete attribute type
        async with attribute_type_service.db_manager.get_enhanced_session() as session:
            result = await attribute_type_service.attribute_type_repository.delete(
                attribute_type_id, session
            )
