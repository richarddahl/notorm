...
from uno.attributes.interfaces import AttributeRepositoryProtocol, AttributeTypeRepositoryProtocol
...
class AttributeRepository(UnoRepository, AttributeRepositoryProtocol):
    ...
    async def get_by_id(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error getting attribute by ID: {str(e)}"))
    ...
    async def get_by_type(
        ...
        try:
            ...
            self.logger.error(f"Error getting attributes by type {attribute_type_id}: {e}")
            return Failure(AttributeRepositoryError(f"Error getting attributes by type: {str(e)}"))
    ...
    async def get_by_meta_record(
        ...
        try:
            ...
            self.logger.error(f"Error getting attributes by meta record {meta_record_id}: {e}")
            return Failure(AttributeRepositoryError(f"Error getting attributes by meta record: {str(e)}"))
    ...
    async def create(
        ...
        try:
            # Convert to model
            model = AttributeModel(**attribute.model_dump(exclude={"attribute_type", "values", "meta_records"}))
            ...
            return Failure(AttributeRepositoryError(f"Error creating attribute: {str(e)}"))
    ...
    async def update(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error updating attribute: {str(e)}"))
    ...
    async def delete(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error deleting attribute: {str(e)}"))
    ...
    async def bulk_create(
        ...
        try:
            # Convert to models
            models = [
                AttributeModel(**attr.model_dump(exclude={"attribute_type", "values", "meta_records"}))
            ...
            return Failure(AttributeRepositoryError(f"Error bulk creating attributes: {str(e)}"))
...
class AttributeTypeRepository(UnoRepository, AttributeTypeRepositoryProtocol):
    ...
    async def get_by_id(
        ...
        try:
            ...
            self.logger.error(f"Error getting attribute type by ID {attribute_type_id}: {e}")
            return Failure(AttributeRepositoryError(f"Error getting attribute type by ID: {str(e)}"))
    ...
    async def get_by_name(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error getting attribute type by name: {str(e)}"))
    ...
    async def get_by_meta_type(
        ...
        try:
            ...
            self.logger.error(f"Error getting attribute types by meta type {meta_type_id}: {e}")
            return Failure(AttributeRepositoryError(f"Error getting attribute types by meta type: {str(e)}"))
    ...
    async def create(
        ...
        try:
            ...
            model = AttributeTypeModel(
                **attribute_type.model_dump(exclude={"applicable_meta_types", "value_meta_types"})
            )
            ...
            return Failure(AttributeRepositoryError(f"Error creating attribute type: {str(e)}"))
    ...
    async def update(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error updating attribute type: {str(e)}"))
    ...
    async def delete(
        ...
        try:
            ...
            return Failure(AttributeRepositoryError(f"Error deleting attribute type: {str(e)}"))