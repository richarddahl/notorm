...
class UserBaseDto(BaseModel):
    ...
    is_superuser: bool = Field(False, description="Indicates that the user is a Superuser")
    tenant_id: Optional[str] = Field(None, description="The Tenant to which the user is assigned")
    default_group_id: Optional[str] = Field(None, description="User's default group, used for creating new objects")
...
class UserUpdateDto(BaseModel):
    ...
    email: Optional[EmailStr] = Field(None, description="Email address, used as login ID")
    handle: Optional[str] = Field(None, description="User's displayed name and alternate login ID")
    full_name: Optional[str] = Field(None, description="User's full name")
    is_superuser: Optional[bool] = Field(None, description="Indicates that the user is a Superuser")
    tenant_id: Optional[str] = Field(None, description="The Tenant to which the user is assigned")
    default_group_id: Optional[str] = Field(None, description="User's default group, used for creating new objects")
    ...
    def validate_fields(self) -> 'UserUpdateDto':
        ...
        fields = [
            self.email, self.handle, self.full_name, self.is_superuser,
            self.tenant_id, self.default_group_id
        ]
...
class UserViewDto(UserBaseDto):
    ...
    group_ids: List[str] = Field(default_factory=list, description="IDs of groups to which the user is assigned")
    role_ids: List[str] = Field(default_factory=list, description="IDs of roles assigned to the user")
...
class UserFilterParams(BaseModel):
    ...
    email_contains: Optional[str] = Field(None, description="Filter by email (contains)")
    handle: Optional[str] = Field(None, description="Filter by handle (exact match)")
    handle_contains: Optional[str] = Field(None, description="Filter by handle (contains)")
    full_name_contains: Optional[str] = Field(None, description="Filter by full name (contains)")
...
class GroupCreateDto(GroupBaseDto):
    ...
    user_ids: Optional[List[str]] = Field(None, description="IDs of users to add to the group")
...
class GroupViewDto(GroupBaseDto):
    ...
    # Navigation properties (returned as IDs, loaded on demand)
    user_ids: List[str] = Field(default_factory=list, description="IDs of users assigned to the group")
...
class RoleBaseDto(BaseModel):
    ...
    responsibility_role_id: str = Field(..., description="The Responsibility that the role's assigned user performs")


class RoleCreateDto(RoleBaseDto):
    """DTO for creating a new role."""
    permission_ids: Optional[List[int]] = Field(None, description="IDs of permissions to add to the role")
    user_ids: Optional[List[str]] = Field(None, description="IDs of users to assign the role to")
...
class RoleUpdateDto(BaseModel):
    ...
    responsibility_role_id: Optional[str] = Field(None, description="The Responsibility that the role's assigned user performs")
...
class RoleViewDto(RoleBaseDto):
    ...
    # Navigation properties (returned as IDs, loaded on demand)
    permission_ids: List[int] = Field(default_factory=list, description="IDs of permissions assigned to the role")
    user_ids: List[str] = Field(default_factory=list, description="IDs of users assigned to the role")
...
class RoleFilterParams(BaseModel):
    ...
    tenant_id: Optional[str] = Field(None, description="Filter by tenant ID")
    responsibility_role_id: Optional[str] = Field(None, description="Filter by responsibility role ID")
...
class ResponsibilityRoleBaseDto(BaseModel):
    ...
    tenant_id: str = Field(..., description="The Tenant that owns the responsibility role")
...
class ResponsibilityRoleUpdateDto(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Responsibility role description")
...
class ResponsibilityRoleViewDto(ResponsibilityRoleBaseDto):
    ...
    created_at: datetime = Field(..., description="Timestamp when the responsibility role was created")
    updated_at: datetime = Field(..., description="Timestamp when the responsibility role was last updated")
...
class ResponsibilityRoleListDto(BaseModel):
    ...
    items: List[ResponsibilityRoleViewDto] = Field(..., description="List of responsibility roles")
    total: int = Field(..., description="Total number of responsibility roles matching the query")
    limit: int = Field(..., description="Maximum number of results returned")
    offset: int = Field(..., description="Number of results skipped")
...
class PermissionViewDto(PermissionBaseDto):
    ...
    # Navigation properties (returned as IDs, loaded on demand)
    role_ids: List[str] = Field(default_factory=list, description="IDs of roles with this permission")
