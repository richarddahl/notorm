...
def mock_model():
    ...
    created_at_col = MockColumn(
        name="created_at",
        type_=MockType(datetime.datetime),
        info={}
    )
    
    count_col = MockColumn(
        name="count",
        type_=MockType(int),
        info={}
    )
...
class TestUnoFilterManager:
    ...
    def test_create_filters_from_table_excluded(self, filter_manager):
        ...
        filters = filter_manager.create_filters_from_table(model, exclude_from_filters=True)
    ...
    def test_create_filters_from_table_with_exclude_fields(self, filter_manager, mock_model):
    ...
    def test_create_filters_from_table_with_graph_excludes(self, filter_manager, mock_model):
    ...
    def test_create_filter_from_column_numeric(self, filter_manager):
        ...
        decimal_column = MockColumn(
            name="price",
            type_=MockType(decimal.Decimal),
            info={}
        )
        float_column = MockColumn(
            name="rate",
            type_=MockType(float),
            info={}
        )
        ...
        decimal_filter = filter_manager._create_filter_from_column(decimal_column, table)
    ...
    def test_create_filter_from_column_datetime(self, filter_manager):
        ...
        date_column = MockColumn(
            name="date",
            type_=MockType(datetime.date),
            info={}
        )
        ...
        time_column = MockColumn(
            name="time",
            type_=MockType(datetime.time),
            info={}
        )
        ...
        datetime_filter = filter_manager._create_filter_from_column(datetime_column, table)
    ...
    def test_create_filter_from_column_with_foreign_key(self, filter_manager, mock_model_with_foreign_keys):
    ...
    def test_create_filter_params(self, filter_manager, mock_model):
        ...
        with patch('uno.queries.filter_manager.create_model') as mock_create_model:
            ...
            assert 'name.starts_with' in fields  # The actual parameter name is starts_with, not startswith
            assert 'name.ends_with' in fields    # The actual parameter name is ends_with, not endswith
    ...
    def test_validate_special_param_order_by_with_direction(self, filter_manager, mock_model):
    ...
    def test_validate_special_param_invalid_order_direction(self, filter_manager, mock_model):
    ...
    def test_validate_special_param_invalid_limit_value(self, filter_manager, mock_model):
