...
from uno.domain.cqrs import Command, Query, CommandHandler, QueryHandler, Dispatcher, get_dispatcher
from uno.domain.command_handlers import (
    ...
    CreateAggregateCommand, CreateAggregateCommandHandler,
    UpdateAggregateCommand, UpdateAggregateCommandHandler,
    DeleteAggregateCommand, DeleteAggregateCommandHandler,
    BatchCommand, BatchCommandHandler
)
...
from uno.domain.repositories import Repository, InMemoryRepository, AggregateRepository, InMemoryAggregateRepository
from uno.domain.unit_of_work import UnitOfWork, InMemoryUnitOfWork
from uno.domain.exceptions import ValidationError, EntityNotFoundError, ConcurrencyError
...
async def test_delete_aggregate_command(dispatcher, command_handlers, test_aggregate_repo):
    ...
    command = DeleteAggregateCommand(
        id="agg-1",
        version=1  # Initial version is 1
    )
