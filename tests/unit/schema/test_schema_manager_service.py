...
class TestSchemaManagerService:
    ...
    def test_initialization(self):
        ...
        for method_name in [
            "add_schema_config", "create_schema", "create_all_schemas", 
            "get_schema", "register_standard_configs", "create_standard_schemas"
        ]:
    ...
    def test_create_all_schemas(self):
        ...
        assert self.logger.debug.call_count >= 3  # Initial call + at least 2 create calls
    ...
    def test_create_standard_schemas(self):
        ...
        assert self.logger.debug.call_count >= 2  # register configs + create all schemas