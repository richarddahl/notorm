...
class TestDecorators:
    ...
    def test_service_decorator(self):
        ...
        assert getattr(DecoratedService, "__uno_service_scope__") == ServiceScope.SINGLETON
    ...
    def test_singleton_decorator(self):
        ...
        assert getattr(DecoratedSingleton, "__uno_service_type__") == TestServiceProtocol
        assert getattr(DecoratedSingleton, "__uno_service_scope__") == ServiceScope.SINGLETON
    ...
    def test_transient_decorator(self):
        ...
        assert getattr(DecoratedTransient, "__uno_service_type__") == TestServiceProtocol
        assert getattr(DecoratedTransient, "__uno_service_scope__") == ServiceScope.TRANSIENT
