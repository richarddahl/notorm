                ...
                if isinstance(node, ast.ClassDef):
                    ...
                    for base in node.bases:
                        if isinstance(base, ast.Name) and (
                            base.id == "BaseModel" or "Model" in base.id
                        ):
                            is_entity = True
                            break
                    ...
                    for class_node in node.body:
                        if isinstance(class_node, ast.AnnAssign) and isinstance(
                            ...
                            if isinstance(class_node.annotation, ast.Name):
                                ...
                                field_type = self._extract_subscript_type(
                    ...
                    if fields:
                        ...
                        return Entity(id=entity_id, name=node.name, fields=fields)
