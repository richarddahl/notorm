...
class EnhancedUnoDb:
    ...
    @retry(
        max_attempts=3,
        retry_exceptions=lambda ex: is_transient_error(ex)
    ...
    @with_pg_error_handling(
        error_message="Error during serializable transaction execution"
    )
    ...
    def _get_model_class_by_name(self, name: str) -> Type[BaseModel]:
        """
