...
class OrderResponse(BaseModel):
    ...
    delivered_at: Optional[str] = Field(None, description="Delivery timestamp (ISO 8601)")
    cancelled_at: Optional[str] = Field(None, description="Cancellation timestamp (ISO 8601)")
    notes: Optional[str] = Field(None, description="Order notes")
