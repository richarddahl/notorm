...
class InventoryUpdateRequest(BaseModel):
    ...
    change: int = Field(..., description="Inventory change amount (positive to add, negative to remove)")
    reason: str = Field(..., min_length=1, description="Reason for the inventory change")
